...
//=================================================//
global.owner = ['6283115282396'] // ubah aja pake nomor lu
//==========================BY Hw Mods=======================//
global.keyopenai = `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`
//====================BY Hw Mods=============================//
global.botname = "xyro" //bah jadi nama bot mu, note tanda ' gausah di hapus!
global.packname = 'KON' // ubah aja ini nama sticker
global.author = 'TOL' // ubah aja ini nama sticker
global.prefa = ['','!','.',',','🐤','🗿']
